...
namespace CraftTech.WebUI.Areas.Admin.Controllers
{
    ...
    public class AboutUsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://craftechmuhendislik.com/api/AboutUs");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://craftechmuhendislik.com/api/AboutUs/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateAbout(ResultAboutDto updateAbout, IFormFile? file)
        {
            ...
            var responseMessage = await client.PutAsync("https://craftechmuhendislik.com/api/AboutUs", content);
            if (responseMessage.IsSuccessStatusCode)
            {
